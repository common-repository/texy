addLoadEvent( function() {
	theFileList = {
      ...
      if ( display && 'title' != display )
        h += "[* " + ( 'thumb' == display ? ( this.currentImage.thumbBase + this.currentImage.thumb ) : ( this.currentImage.srcBase + this.currentImage.src ) ) + ( this.currentImage.title ? " .(" + this.currentImage.title + ") " : "" ) + " *]";
      else
        h += "\"" + this.currentImage.title + "\"" ;
      if ( 'none' != link )
        h += ":" + ( 'file' == link ? ( this.currentImage.srcBase + this.currentImage.src ) : ( this.currentImage.page + " .{rel: attachment wp-att-" + this.currentImage.ID + "}" ) );
